...
void main() {
  ...
  pos += 0.2 * perlin4d(vec4(pos, uTime * 0.1));
  float perlinStrength = perlin4d(vec4(pos, uTime * 0.3));
  ...
  float t = smoothstep(0.8, 1.2, dist); // normalize between min and max distance
